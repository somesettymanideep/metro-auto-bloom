...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DR0ePXOQ.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BWz29wrm.js"),
    import("./start-DDlEggZ-.js"),
...
var ROUTER_BASEPATH = "metro-auto-bloom";
var SERVER_FN_BASE = "/metro-auto-bloom/_serverFn/";
